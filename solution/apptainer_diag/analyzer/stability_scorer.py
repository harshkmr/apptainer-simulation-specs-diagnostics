...
def calculate_risk_scores(
    ...
    Formula: Overall Score = 0.45 * Memory Safety Risk + 0.40 * Solver Stability Risk + 0.15 * Resource Limits Risk
    """
    ...
    # 4. Overall Score calculation (Weighted combination: 0.45 * Memory + 0.40 * Solver + 0.15 * Resource)
    overall = (mem_risk * 0.45) + (num_risk * 0.40) + (res_risk * 0.15)
